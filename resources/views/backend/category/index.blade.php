<x-backend-layout>
    <div class="p-4 sm:ml-64 mt-10">
        <div class="p-4  mt-14">
            ...
            <div class="mb-10">
                <a href="{{ route('create.category') }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Create new category
                </a>
            </div>
